...
- The latest in-app connection-test and model-refresh results are stored in local settings under `providerStatus`; API keys remain in encrypted secret storage and are never copied into status records.
